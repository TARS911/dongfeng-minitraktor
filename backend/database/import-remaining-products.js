...
const products = [
  {
    ...
    description:
      "Минитрактор Xingtai (Синтай) 244 с кабиной - надежная китайская техника по доступной цене.",
    price: 310000,
    power: 24,
    drive: "4x4",
    transmission: "8+8",
  ...
  },
  {
    ...
    category_slug: "minitractory",
    description:
      "Минитрактор Xingtai (Синтай) 244 в базовой комплектации. Экономичный и надежный помощник.",
    price: 275000,
    power: 24,
    drive: "4x4",
    transmission: "8+8",
  ...
  },
  {
    ...
    category_slug: "minitractory",
    description:
      "Трактор LOVOL TE-244 - надежная техника от известного китайского производителя.",
    price: 295000,
    power: 24,
    drive: "4x4",
    transmission: "8+8",
  ...
  },
  {
    ...
    category_slug: "minitractory",
    description:
      "Российский минитрактор Кентавр 244 - надежность и качество отечественного производства.",
    price: 290000,
    power: 24,
    drive: "4x4",
    transmission: "8+8",
  ...
  },
  {
    ...
    category_slug: "minitractory",
    description:
      "Минитрактор Русич 244 - качественная российская техника для сельского хозяйства.",
    price: 285000,
    power: 24,
    drive: "4x4",
    transmission: "8+8",
  ...
  },
  {
    ...
    category_slug: "minitractory",
    description:
      "Минитрактор Скаут 244 - современная техника с отличным соотношением цены и качества.",
    price: 280000,
    power: 24,
    drive: "4x4",
    transmission: "8+8",
  ...
  },
  {
    ...
    category_slug: "minitractory",
    description:
      "Минитрактор Рустрак 244 - надежная техника российского производства.",
    price: 292000,
    power: 24,
    drive: "4x4",
    transmission: "8+8",
...
async function importProducts() {
  try {
    ...
    if (catsError || !cats) {
      ...
      console.error(
        "Сначала запустите import-to-supabase.js для создания категорий.",
      );
      return;
    }

    const categoryId = cats.id;
    console.log(`✅ Категория найдена: minitractory (ID: ${categoryId})\n`);
    ...
    console.log(
      "📊 Проверьте: https://supabase.com/dashboard/project/wbfhvcmvkyjsjvqkbxpz/editor",
    );
  } catch (error) {
