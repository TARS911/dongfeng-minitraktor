...
export const metadata: Metadata = {
  title: "Мини-тракторы Xingtai | БелТехФермЪ",
  description: "Купите мини-тракторы Xingtai. Большой выбор, низкие цены, доставка по России.",
};
...
export default async function XingtaiPage() {
  const products = await getProductsByCategory("xingtai");
