...
export const metadata: Metadata = {
  ...
  description:
    "Купите мини-тракторы с доставкой по России. Официальная гарантия, техническое обслуживание.",
};
...
export default async function MinitractoryPage() {
  const products = await getProductsByCategory("minitractory");

  return (
    <div className="catalog-container">
      <div className="catalog-header">
        <h1>Мини-тракторы</h1>
        <p>Надежная и производительная техника для вашего хозяйства</p>
