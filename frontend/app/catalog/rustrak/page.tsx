...
export const metadata: Metadata = {
  title: "Мини-тракторы Рустрак | БелТехФермЪ",
...
export default async function RustrakPage() {
  const products = await getProductsByCategory("rustrak");
