#!/usr/bin/env python3
"""
Парсер ВСЕХ запчастей DongFeng с ZIP-AGRO.RU
URL: https://zip-agro.ru/dongfeng
"""
...
BASE_URL = "https://zip-agro.ru/dongfeng"
        ...
        for item in items:
            try:
                ...
                products.append({
                    'name': name,
                    'article': article,
                    'category': 'Запчасти DongFeng (все модели)'
                })
...
def main():
    print("\n🚀 ПАРСИНГ ВСЕХ ЗАПЧАСТЕЙ DONGFENG С ZIP-AGRO.RU")
    print("=" * 70)
    ...
    csv_file = output_dir / "zip-agro-dongfeng-full.csv"
    json_file = output_dir / "zip-agro-dongfeng-full.json"
